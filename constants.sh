...
TAGS=(
    ...
    ${DEBUG_ALPINE_GOLANG}
    ${DEBUG_ALPINE_GOLANG1_12_1}
    ${DEBUG_ALPINE3_9_GOLANG}
    ${DEBUG_ALPINE3_9_GOLANG1_12_1}

    ${DEBUG_UBUNTU}
    ${DEBUG_UBUNTU18_04}

    ${DEBUG_UBUNTU_GOLANG}
    ${DEBUG_UBUNTU_GOLANG1_12_1}
    ${DEBUG_UBUNTU18_04_GOLANG}
    ${DEBUG_UBUNTU18_04_GOLANG1_12_1}
)
